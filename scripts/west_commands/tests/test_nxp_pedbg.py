...
TEST_ALL_PARAMS = [
    ...
    *[f'--tool-opt={o}' for o in TEST_TOOL_OPT],
    # from runner
    '--nxpide-path', TEST_S32DS_PATH_OVERRIDE,
    '--pemicro-plugin-path', TEST_PEMICRO_PLUGIN_PATH,
...
def pedbg(runner_config, tmp_path):
    ...
    def _factory(args):
        ...
        if isinstance(args, dict):
            ...
            return NXPPEDebugProbeRunner(runner_config_patched, probe_cfg,
                                          **args['NXPPEDebugProbeRunner'])
...
def test_debugserver(require, check_call, system,
                     pedbg_args, expected, osname, pedbg):
