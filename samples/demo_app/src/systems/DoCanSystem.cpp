...
namespace
{
static uint32_t const TIMEOUT_DOCAN_SYSTEM   = 10U;
static size_t const TICK_DELTA_TICKS         = 2U;   // Tick delta
static size_t const TICK_100MS               = 100U; // 100us ticks
static uint16_t const ALLOCATE_TIMEOUT       = 1000U;
...
static uint16_t const MIN_SEPARATION_TIME    = 2U;
static uint8_t const BLOCK_SIZE              = 15U;
