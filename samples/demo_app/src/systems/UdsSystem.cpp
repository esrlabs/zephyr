...
uint8_t const responseData_22f186[]
...
, _read_22f186(0xf186, responseData_22f186)
, _read_22f102()
, _testerPresent()
, _context(context)
, _timeout()
...
{
    removeDiagJobs();
    _diagnosticSessionControl.setDiagDispatcher(0L);
...
void UdsSystem::shutdownComplete(
...
IAsyncDiagHelper& UdsSystem::getAsyncDiagHelper()
{
    return _asyncDiagHelper;
}

IDiagSessionManager& UdsSystem::getDiagSessionManager()
{
...
CommunicationControl& UdsSystem::getCommunicationControl()
{
    return _communicationControl;
}

ReadDataByIdentifier& UdsSystem::getReadDataByIdentifier()
{
    return _readDataByIdentifier;
}
